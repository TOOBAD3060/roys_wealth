...
import Phantom from '/public/assets/wallets/Phantom.png'
import WalletConnect from '/public/assets/wallets/WalletConnect.png'
import Coinbase from '/public/assets/wallets/Coinbase.png'
import MetaMask from '/public/assets/wallets/MetaMask.png'
import PhantomRounded from '/public/assets/wallets/Phantom-rounded.png'
import WalletConnectRounded from '/public/assets/wallets/WalletConnect-rounded.png'
import CoinbaseRounded from '/public/assets/wallets/Coinbase-rounded.png'
import MetaMaskRounded from '/public/assets/wallets/MetaMask-rounded.png'
import Link from 'next/link'
import { useRouter } from 'next/navigation'
import Transitions from '@/components/home/Transition'
import Loader from '@/components/home/Loader'
import InputWrapper from '@/components/cart/InputWrapper'
      ...
      <Transitions>
            ...
            <div className={`max-w-[1064px] mx-auto pb-8 px-4 md:px-0`}>
                <div className='w-3/5 mx-auto mb-8 hidden md:block'>
                    <buthrefn className='cart-btn'><Link href="/cart">Shopping cart </Link></buthrefn>
                    <buthrefn className='cart-btn'><Link href="/shipping-details">Shipping details </Link></buthrefn>
                    <buthrefn className='cart-btn active-cart-btn'>Payment details</buthrefn>
                </div>
                <main>
                        ...
                        <form onSubmit={handleSubmit} className=" md:w-1/2">
                            <section className='md:shadow-[0px_0px_5px_rgba(0,0,0,0.25)] rounded-[0.5rem] md:p-8'>
                                ...
                                <div className='ml-auto flex items-center justify-around h-[42px] my-4 md:hidden'>
                                    <Image src={PhantomRounded} alt="" />
                                    <Image src={WalletConnectRounded} alt="" />
                                    <Image src={CoinbaseRounded} alt="" />
                                    <Image src={MetaMaskRounded} alt="" />
                                ...
                                <InputWrapper>
                                    ...
                                    <div className='inputStyle flex '>
                                        <input 
                                            ...
                                            required
                                        />
                                        <Image src={Phantom} alt="" className='h-8'/>
                                    </div>
                                </InputWrapper>
                                <InputWrapper>
