...
import Recommended from "@/components/productItems/Recommended";
import ProductSubs from "@/components/productItems/ProductSubs";
            ...
            <div className="container mx-auto px-4 md:px-0 pb-20 md:mb-0">
                <div className="max-w-[1064px] mx-auto">
                    <section className='font-medium md:leading-[200%] mb-8 md:mb-10 border-b-[0.5px] md:border-b-0 border-b-grey leading-[52px]'>
                        <span className='text-[#BCB7B7]'><Link href="/">Home/</Link> <Link href="marketplace">Marketplace/</Link> Editorial/</span>
