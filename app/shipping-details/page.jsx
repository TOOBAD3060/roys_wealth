...
function CartShippingDetails(){
  ...
  return (
    ...
    <div className='w-3/5 mx-auto mb-8 hidden md:block'>
        <Link href="/carts"><button className='cart-btn'>Shopping cart</button></Link>
    ...
    <main className='flex gap-16 justify-end'>
        <form ref={checkoutForm} onSubmit={handleSubmit} className="w-full md:w-0  grow-0 overflow-hidden">
            ...
            <Link href="/cart" className='md:hidden'><span className='text-lg underline text-[#006CA2] block text-center my-7'>Go Back to cart</span></Link>
        </form>
        {/* cart checkout */}
