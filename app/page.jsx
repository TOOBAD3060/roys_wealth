            ...
            <div className="container font-clash mx-auto md:py-[75px] relative">
              <div className="overflow-hidden relative">
                ...
                <p className="text-[13px] md:text-3xl relative leading-[130%] text-black/[0.57] font-[200] md:mr-[12rem] mt-9">
                  ...
                  Everything always as if it were the first time; there’s always
                  more people in a black and white photograph. It just makes it
                  seem that there were more people at a gig, more people at a
                  football match, than with colour photography. Everything looks
